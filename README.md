...
* [Information for Modders](#index6)
  ...
  * [THUMBNAILS](#index6.6)
  * [ALBINO / COLORED CREATURES (no code)](#index6.7)
* [Known issues](#index7)
* [Credits](#index8)
...
3) Apply **all** (`CustomRegions.dll`, `EnumExtender.dll`, `ConfigMachine.dll`, and finally `CustomAssets.dll`(if you want custom music)) the mods inside the [DOWNLOAD_THIS_Custom-Regions-vX.X.zip](https://github.com/Garrakx/Custom-Regions/releases/) file. You will receive updates automatically.
...
### <a name="index6.7"></a>ALBINO / COLORED CREATURES
